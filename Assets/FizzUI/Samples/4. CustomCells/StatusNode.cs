...
namespace Fizz.Demo
{
    ...
    public class StatusNode : MonoBehaviour
    {
        ...
        private void OnDeleteButtonPressed()
        {
            ...
            try
            {
                FizzService.Instance.Client.Chat.DeleteMessage(_message.To, _message.Topic, _message.Id, ex =>
                {
                    if (ex == null)
                    {
        ...
        private void UpdateStatus(string status)
        {
            ...
            try
            {
                ...
                FizzService.Instance.Client.Chat.UpdateMessage(_message.To, _message.Topic, _message.Id, _message.Nick, _message.Body, data, true, false, true, ex =>
                {
                    if (ex == null)
                    {
